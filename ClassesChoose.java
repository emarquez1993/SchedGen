...
public class ClassesChoose extends SignUp {
	...
	public ClassesChoose() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        ClassesChoose.this.setLocation(x - xx, y - xy);  
		...
		lblClasses.setForeground(UIManager.getColor("Button.select"));
		lblClasses.setBounds(201, 11, 91, 38);
		panel.add(lblClasses);
		
		JButton btnAddClasses = new JButton("Add Classes");
		btnAddClasses.addActionListener(new ActionListener() {
		...
		btnAddClasses.setBounds(181, 91, 140, 29);
		panel.add(btnAddClasses);
		
		JButton btnDeleteClasses = new JButton("Delete Classes");
		btnDeleteClasses.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
		...
		btnDeleteClasses.setBounds(181, 199, 140, 29);
		panel.add(btnDeleteClasses);
		
		JButton btnUpdateClasses = new JButton("View Classes");
		...
		btnUpdateClasses.setBounds(181, 295, 140, 29);
		panel.add(btnUpdateClasses);
