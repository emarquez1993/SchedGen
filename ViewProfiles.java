...
public class ViewProfiles extends SignUp {
	...
	public ViewProfiles() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        ViewProfiles.this.setLocation(x - xx, y - xy);  
...
//Labels
		...
		JLabel lblViewProfiles_1 = new JLabel("View Profiles");
		...
		lblViewProfiles_1.setBounds(194, 35, 160, 36);
...
//Enter Java/SQL connection here that can search for 
					...
					{
						ViewProfiles.setStId(SStudentIDtxtField.getText());
						...
						JOptionPane.showMessageDialog(null,"The ID you entered does not match any students. Please try again.", "ERROR", JOptionPane.INFORMATION_MESSAGE);
					
				}
				else if(SStudentIDtxtField.getText().equals("")) {
					if(Teacher.teacherExists(TeacherIDtxtField.getText()))
					{
						ViewProfiles.setTeacherId(TeacherIDtxtField.getText());
						//Get infromation of the variable ID from the database
						//You can change it int if needed
						dispose();
						...
						JOptionPane.showMessageDialog(null,"The ID you entered does not match any teachers. Please try again.", "ERROR", JOptionPane.INFORMATION_MESSAGE);
